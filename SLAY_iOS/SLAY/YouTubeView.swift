                  ...
                  //  Color.clear.edgesIgnoringSafeArea(.all)
                    VStack{
                        VStack {
                            ...
                            if let selectedYoutube2 = selectedYoutube?.youtubeID {
                                // if let fashionShow = selectedBrand?.youtubeID {
                                
                                VideoView(videoID: selectedYoutube2, selectedBrand: $selectedBrand, selectedYoutube: $selectedYoutube)
                        ...
                        VStack{
                            ...
                            VStack{
                                ScrollView(.vertical){
                                    ...
                                    if let selectedYoutube3 = selectedYoutube {
...
//                                
    ...
    func CustomIndicator()->some View{
        HStack(spacing: 5){
            ...
            ForEach(ha.indices,id: \.self){index in
                Circle()
...
struct youtuve_Previews: PreviewProvider {
    
    static var previews: some View {
       // YouTube3(selectedBrand: .constant(nil), selectedYoutube: .constant(nil))
...
//        guard let youtubeURL = URL(string: "https://www.youtube.com/live/Wr4w5i1xFEo?feature=share") else { return }

    func updateUIView(_ uiView: WKWebView, context: Context) {
       // guard let youtubeURL = URL(string: "\(selectedBrand.youtubeURL)") else { return }
        guard let youtubeURL = URL(string: "\(selectedYoutube.youtubeURL)") else { return }
